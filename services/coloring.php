<?php
$page_title = "Окрашивание в один тон | Muse | Салон красоты";
...
<section class="relative min-h-[60vh] flex items-center justify-center pt-20 overflow-hidden bg-stone-900">
    <div class="absolute inset-0 z-0">
        <img src="<?php echo $base_url; ?>/assets/images/hero.jpg" alt="Окрашивание в один тон" class="w-full h-full object-cover opacity-60">
    </div>
    <div class="container mx-auto px-6 relative z-10 text-center">
        <div class="max-w-3xl mx-auto">
            ...
            <h1 class="text-5xl md:text-7xl font-serif leading-[0.9] text-white mb-6">Окрашивание в один тон</h1>
            <p class="text-stone-200 text-lg md:text-xl font-light max-w-2xl mx-auto leading-relaxed">
                Классическое окрашивание для равномерного и насыщенного цвета
            </p>
        </div>
    </div>
</section>
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <div class="relative reveal">
                <div class="relative z-10 img-zoom-container rounded-[2rem] overflow-hidden shadow-xl aspect-[4/5]">
                    <img src="<?php echo $base_url; ?>/assets/images/about.jpg" alt="Процесс окрашивания" class="w-full h-full object-cover img-zoom">
                </div>
                <div class="absolute -bottom-6 -right-6 w-32 h-32 bg-rose-200 rounded-full blur-3xl -z-10 opacity-60"></div>
            </div>
            <div class="reveal">
                <h2 class="text-4xl md:text-5xl font-serif text-stone-900 mb-8">Идеальное покрытие цветом</h2>
                <p class="text-stone-600 font-light leading-relaxed mb-6">
                    Наше окрашивание в один тон — это гарантия равномерного, насыщенного и долговечного результата. Мы используем только премиальные красители, которые бережно относятся к структуре волос.
                </p>
                <p class="text-stone-600 font-light leading-relaxed mb-6">
                    Процедура включает профессиональную консультацию, подбор идеального оттенка с учетом вашего тона кожи, предварительную диагностику состояния волос и комплексный уход после окрашивания.
                </p>
                <p class="text-stone-600 font-light leading-relaxed">
                    Наши мастера имеют сертификаты ведущих брендов окрашивания и регулярно проходят обучение новым техникам и технологиям.
                </p>
            </div>
        </div>
    </div>
...
<section class="py-24 bg-[#faf9f6]">
    <div class="container mx-auto px-6">
        <div class="text-center mb-16 reveal">
            ...
            <p class="text-stone-500 max-w-2xl mx-auto">Цены зависят от длины волос и сложности процедуры</p>
        </div>
        ...
        <div class="max-w-3xl mx-auto bg-white rounded-[2rem] shadow-sm p-8 mb-16 reveal">
            <div class="flex justify-between items-center py-6 border-b border-stone-100">
                <div>
                    <h3 class="text-xl text-stone-800">Окрашивание в один тон (короткие волосы)</h3>
                    <p class="text-stone-500 text-sm mt-1">До плеч</p>
                </div>
            ...
            <div class="flex justify-between items-center py-6 border-b border-stone-100">
                <div>
                    <h3 class="text-xl text-stone-800">Окрашивание в один тон (средние волосы)</h3>
                    <p class="text-stone-500 text-sm mt-1">До лопаток</p>
                </div>
                <span class="text-2xl font-serif text-rose-400">5500 ₽</span>
            </div>
            
            <div class="flex justify-between items-center py-6 border-b border-stone-100">
                <div>
                    <h3 class="text-xl text-stone-800">Окрашивание в один тон (длинные волосы)</h3>
                    <p class="text-stone-500 text-sm mt-1">Ниже лопаток</p>
                </div>
                <span class="text-2xl font-serif text-rose-400">6500 ₽</span>
            </div>
            
            <div class="flex justify-between items-center py-6">
                <div>
                    <h3 class="text-xl text-stone-800">Тонирование</h3>
                    <p class="text-stone-500 text-sm mt-1">Освежение цвета без аммиака</p>
                </div>
...
<section class="py-24 bg-white">
    <div class="container mx-auto px-6">
        <div class="text-center mb-16 reveal">
            ...
            <p class="text-stone-500 max-w-2xl mx-auto">Эксперт в области цвета с чувством оттенка</p>
        </div>
        ...
        <div class="max-w-4xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            ...
            <div class="reveal">
                ...
                <p class="text-stone-600 font-light leading-relaxed mb-6">
                    Арт-директор салона, эксперт по цвету с более чем 10-летним опытом. Специализируется на создании идеального цвета для каждого клиента с учетом его индивидуальных особенностей.
                </p>
...
<section class="py-24 bg-stone-900 text-white relative overflow-hidden">
    ...
    <div class="container mx-auto px-6 relative z-10">
        <div class="text-center max-w-3xl mx-auto mb-16 reveal">
            ...
            <h2 class="text-4xl md:text-5xl font-serif mb-6">Как сохранить цвет дольше</h2>
            <p class="text-stone-400 font-light">Советы от наших экспертов по уходу за окрашенными волосами</p>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div class="bg-stone-800/50 p-8 rounded-[2rem] backdrop-blur-sm reveal">
                ...
                <h3 class="text-xl font-serif text-white mb-4">Используйте профессиональный шампунь</h3>
                <p class="text-stone-400 text-sm leading-relaxed">
                    Выбирайте шампуни и кондиционеры для окрашенных волос. Они содержат компоненты, которые помогают сохранить яркость цвета.
                </p>
            </div>
            ...
            <div class="bg-stone-800/50 p-8 rounded-[2rem] backdrop-blur-sm reveal" style="transition-delay: 100ms;">
                ...
                <h3 class="text-xl font-serif text-white mb-4">Мойте волосы правильно</h3>
                <p class="text-stone-400 text-sm leading-relaxed">
                    Используйте прохладную воду для полоскания, так как горячая вода открывает чешую волоса и способствует вымыванию пигмента.
                </p>
            </div>
            ...
            <div class="bg-stone-800/50 p-8 rounded-[2rem] backdrop-blur-sm reveal" style="transition-delay: 200ms;">
                ...
                <h3 class="text-xl font-serif text-white mb-4">Защищайте от внешних факторов</h3>
                <p class="text-stone-400 text-sm leading-relaxed">
                    Носите головной убор на солнце и используйте термозащитные средства перед использованием горячих приборов.
                </p>
            </div>
        </div>
    </div>
