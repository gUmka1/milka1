<?php
$page_title = "SPA-уход для рук | Muse | Салон красоты";
...
<section class="relative min-h-[60vh] flex items-center justify-center pt-20 overflow-hidden bg-stone-900">
    <div class="absolute inset-0 z-0">
        <img src="<?php echo $base_url; ?>/assets/images/hero.jpg" alt="SPA-уход для рук" class="w-full h-full object-cover opacity-60">
    </div>
    <div class="container mx-auto px-6 relative z-10 text-center">
        <div class="max-w-3xl mx-auto">
            ...
            <h1 class="text-5xl md:text-7xl font-serif leading-[0.9] text-white mb-6">SPA-уход для рук</h1>
            <p class="text-stone-200 text-lg md:text-xl font-light max-w-2xl mx-auto leading-relaxed">
                Комплексная процедура для восстановления красоты и здоровья ваших рук
            </p>
        </div>
    </div>
</section>
...
<section class="py-24 bg-white">
    <div class="container mx-auto px-6">
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <div class="reveal">
                <h2 class="text-4xl md:text-5xl font-serif text-stone-900 mb-8">Роскошный уход для ваших рук</h2>
                <p class="text-stone-600 font-light leading-relaxed mb-6">
                    Наш SPA-уход для рук — это комплексная процедура, направленная на восстановление красоты и здоровья кожи ваших рук. Процедура включает очищение, пилинг, маску, массаж и питательное покрытие.
                </p>
                <p class="text-stone-600 font-light leading-relaxed mb-6">
                    Мы используем только премиальные косметические средства известных брендов, которые богаты витаминами, антиоксидантами и увлажняющими компонентами. Каждый этап процедуры тщательно продуман для достижения максимального эффекта.
                </p>
                <p class="text-stone-600 font-light leading-relaxed">
                    После процедуры ваши руки станут мягкими, гладкими и ароматными. Эффект сохраняется на протяжении нескольких дней, а регулярные посещения помогут поддерживать кожу в отличном состоянии.
                </p>
            </div>
            <div class="relative reveal">
                <div class="relative z-10 img-zoom-container rounded-[2rem] overflow-hidden shadow-xl aspect-[4/5]">
                    <img src="<?php echo $base_url; ?>/assets/images/about.jpg" alt="Процесс SPA-ухода для рук" class="w-full h-full object-cover img-zoom">
                </div>
...
<section class="py-24 bg-[#faf9f6]">
    <div class="container mx-auto px-6">
        <div class="text-center mb-16 reveal">
            ...
            <p class="text-stone-500 max-w-2xl mx-auto">Выберите подходящий уровень ухода для ваших рук</p>
        </div>
        ...
        <div class="max-w-3xl mx-auto bg-white rounded-[2rem] shadow-sm p-8 mb-16 reveal">
            <div class="flex justify-between items-center py-6 border-b border-stone-100">
                <div>
                    <h3 class="text-xl text-stone-800">Классический SPA</h3>
                    <p class="text-stone-500 text-sm mt-1">Очищение + пилинг + маска + крем</p>
                </div>
            ...
            <div class="flex justify-between items-center py-6 border-b border-stone-100">
                <div>
                    <h3 class="text-xl text-stone-800">Премиум SPA</h3>
                    <p class="text-stone-500 text-sm mt-1">Классический SPA + парафинотерапия</p>
                </div>
            ...
            <div class="flex justify-between items-center py-6 border-b border-stone-100">
                <div>
                    <h3 class="text-xl text-stone-800">Антивозрастной SPA</h3>
                    <p class="text-stone-500 text-sm mt-1">Премиум SPA + алгinate маска</p>
                </div>
            ...
            <div class="flex justify-between items-center py-6">
                <div>
                    <h3 class="text-xl text-stone-800">SPA-уход + маникюр</h3>
                    <p class="text-stone-500 text-sm mt-1">Комплексная процедура для полного ухода</p>
                </div>
...
<section class="py-24 bg-white">
    <div class="container mx-auto px-6">
        <div class="text-center mb-16 reveal">
            ...
            <p class="text-stone-500 max-w-2xl mx-auto">Эксперт в области SPA-процедур</p>
        </div>
        ...
        <div class="max-w-4xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            ...
            <div class="reveal">
                ...
                <p class="text-stone-600 font-light leading-relaxed mb-6">
                    Мастер маникюра с 8-летним опытом работы. Специализируется на SPA-процедурах для рук и ног, имеет сертификаты ведущих косметологических брендов.
                </p>
                ...
                <div class="space-y-4 mb-8">
                    ...
                    <div class="flex items-center">
                        ...
                        <span>Диплом по косметологии и дерматологии</span>
                    </div>
                    <div class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-rose-400 mr-3">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                        </svg>
                        <span>Регулярное участие в семинарах по SPA-технологиям</span>
                    </div>
                </div>
...
<section class="py-24 bg-stone-900 text-white relative overflow-hidden">
    ...
    <div class="container mx-auto px-6 relative z-10">
        <div class="text-center max-w-3xl mx-auto mb-16 reveal">
            ...
            <h2 class="text-4xl md:text-5xl font-serif mb-6">Как ухаживать за руками дома</h2>
        ...
        <div class="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div class="bg-stone-800/50 p-8 rounded-[2rem] backdrop-blur-sm reveal">
                ...
                <h3 class="text-xl font-serif text-white mb-4">Ежедневное увлажнение</h3>
                <p class="text-stone-400 text-sm leading-relaxed">
                    Наносите питательный крем на руки минимум 2 раза в день, особенно после контакта с водой и моющими средствами.
                </p>
            </div>
            ...
            <div class="bg-stone-800/50 p-8 rounded-[2rem] backdrop-blur-sm reveal" style="transition-delay: 100ms;">
                ...
                <h3 class="text-xl font-serif text-white mb-4">Питательные маски</h3>
                <p class="text-stone-400 text-sm leading-relaxed">
                    Раз в неделю делайте питательные маски для рук из натуральных ингредиентов: меда, оливкового масла, авокадо.
                </p>
            </div>
            ...
            <div class="bg-stone-800/50 p-8 rounded-[2rem] backdrop-blur-sm reveal" style="transition-delay: 200ms;">
                ...
                <h3 class="text-xl font-serif text-white mb-4">Защита от внешних факторов</h3>
                <p class="text-stone-400 text-sm leading-relaxed">
                    Используйте перчатки при уборке и работе с химическими веществами, а также в холодное время года.
                </p>
            </div>
        </div>
    </div>
